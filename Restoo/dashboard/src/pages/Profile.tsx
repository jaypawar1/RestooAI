        ...
        <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            <div className='w-[100%] flex justify-start'>
              <div className="relative flex z-30 -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
              ...
              <div className=' pl-5 pt-3 text-[20px] font-semibold text-black font-sans'>
                <span className='text-[#505050]'>Your current </span> <span className='text-[#4BC500]'>credit score</span> is : 2250
              </div>
            </div>
            <div className=' flex justify-between px-15 py-1 mx-auto w-[593px] bg-[#F5F4F4] rounded-xl'>
              <div className='p-2 text-black text-[18px] font-semibold'>User Info </div>
              <div className='p-2 text-black text-[18px] font-semibold'>My plan</div>
              <div className='p-2 text-black text-[18px] font-semibold'>Pos integration</div>
            </div>
            <div className="mt-4">
