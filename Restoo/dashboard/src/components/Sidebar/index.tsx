...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-90 flex-col overflow-y-hidden bg-white duration-300 ease-linear  lg:static lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'
        }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-between gap-2 px-10 py-10 lg:py-10">
        <NavLink to="/">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/FeedbackAnalysis"
                  className={`group relative flex items-center gap-2.5 rounded-lg  py-2 px-4 font-bold   text-black  duration-300 ease-in-out hover:bg-[#BAE8B3]   dark:hover:bg-meta-4 ${(pathname === '/forms' ||
